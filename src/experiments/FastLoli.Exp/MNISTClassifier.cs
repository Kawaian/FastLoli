...
namespace FastLoli.Exp
{
    ...
    public class MNISTClassifier
    {
        ...
        public static void TrainAndEvaluate(DeviceDescriptor device, bool useConvolution, bool forceRetrain)
        {
            ...
            TrainingParameterScheduleDouble learningRatePerSample = new CNTK.TrainingParameterScheduleDouble(0.003125, 1);
            ...
            int hStride, int vStride, int poolingWindowWidth, int poolingWindowHeight)
        {
            ...
            var convParams = new Parameter(new int[] { kernelWidth, kernelHeight, numInputChannels, outFeatureMapCount }, DataType.Float, CNTKLib.GlorotUniformInitializer(convWScale, -1, 2), device);
